...
def load_and_run(args):
    ...
    print "*************************"
    print "NORMAL: "
    cp.summarize_fit(coefs, intercepts, fit_result_df, filename="fit_all_summary_normal.txt", hyper=best_hyper,
    ...
    if args.plot_coef_fdr:
        ...
        for i, fdr in zip(range(len(fdrs)), fdrs):
            ...
            cp.plot_all_coef(acoefs_fdr, df, genes, lag, file_prefix="plots" + os.sep + "fdr-" + str(fdr) + os.sep + save_prefix+ "-",
            ...
            if args.load_reps:
                cp.plot_all_coef(acoefs_fdr, df, genes, lag, file_prefix="plots" + os.sep + "fdr-" + str(fdr) + os.sep + save_prefix+ "-nobar-",
